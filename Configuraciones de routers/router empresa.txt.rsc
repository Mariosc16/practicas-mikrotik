# jun/02/2023 19:58:21 by RouterOS 6.48.6
# software id = A18R-GX1D
#
# model = RB952Ui-5ac2nD
# serial number = HDG08P8FANA
/interface bridge
add admin-mac=48:A9:8A:0E:22:88 auto-mac=no comment=defconf name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=2ghz-b/g/n channel-width=20/40mhz-XX \
    disabled=no distance=indoors frequency=auto installation=indoor mode=\
    ap-bridge ssid=Empresa wireless-protocol=802.11
set [ find default-name=wlan2 ] band=5ghz-a/n/ac channel-width=\
    20/40/80mhz-XXXX disabled=no distance=indoors frequency=auto \
    installation=indoor mode=ap-bridge ssid="Empresa 5G" wireless-protocol=\
    802.11
/interface list
...
add address=192.168.22.1/24 comment=defconf interface=bridge network=\
    192.168.22.0
add address=192.168.70.44/24 interface=ether1 network=192.168.70.0
/ip dhcp-client
